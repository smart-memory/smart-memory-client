...
class TestClientFullCoverage:
    ...
    def test_admin_methods(self, client, mock_request):
        ...
        mock_request.assert_called_with("POST", "/memory/admin/prune", params={"strategy": "old", "days": 365, "dry_run": True})

        client.find_old_notes(days=30)
        mock_request.assert_called_with("GET", "/memory/admin/old-notes", params={"days": 30})
    ...
    def test_auth_methods(self, client, mock_request):
        ...
        mock_request.assert_called_with("POST", "/auth/login", json_body={
    ...
    def test_ontology_methods(self, client, mock_request):
        ...
        mock_request.assert_called_with("POST", "/memory/ontology/inference/run", json_body={
        ...
        mock_request.assert_called_with("POST", "/memory/ontology/registries", json_body={
            "name": "My Registry", "description": "", "domain": "general"
        })

        client.get_registry_snapshot("reg-1")
        mock_request.assert_called_with("GET", "/memory/ontology/registry/reg-1/snapshot", params=None)

        client.apply_changeset("reg-1", {"add": []})
        mock_request.assert_called_with("POST", "/memory/ontology/registry/reg-1/apply", json_body={
            "base_version": "", "changeset": {"add": []}, "message": ""
        })

        client.list_registry_snapshots("reg-1")
        mock_request.assert_called_with("GET", "/memory/ontology/registry/reg-1/snapshots", params={"limit": 50})

        client.get_registry_changelog("reg-1")
        mock_request.assert_called_with("GET", "/memory/ontology/registry/reg-1/changelog", params={"limit": 50})

        client.rollback_registry("reg-1", target_version="v1")
        mock_request.assert_called_with("POST", "/memory/ontology/registry/reg-1/rollback", json_body={
            "target_version": "v1", "message": ""
        })

        client.export_registry("reg-1")
        mock_request.assert_called_with("GET", "/memory/ontology/registry/reg-1/export", params={})

        client.import_registry("reg-1", {"data": "test"})
        mock_request.assert_called_with("POST", "/memory/ontology/registry/reg-1/import", json_body={
        ...
        mock_request.assert_called_with("POST", "/memory/ontology/enrichment/run", json_body={
            "provider": "wikipedia", "entities": ["entity1"], "user_id": None
        })

        client.run_grounding_ontology("item-1", ["cand1"])
        mock_request.assert_called_with("POST", "/memory/ontology/grounding/run", json_body={
    ...
    def test_pipeline_methods(self, client, mock_request):
        ...
        mock_request.assert_called_with("POST", "/memory/pipeline/extraction", json_body={
            "content": "content", "extractor_name": "llm"
        })

        client.run_storage_stage({"data": "extracted"})
        mock_request.assert_called_with("POST", "/memory/pipeline/storage", json_body={
            "extracted_data": {"data": "extracted"}, "storage_strategy": "standard"
        })

        client.run_linking_stage([{"entity": "e1"}])
        mock_request.assert_called_with("POST", "/memory/pipeline/linking", json_body={
            "stored_entities": [{"entity": "e1"}], "linking_algorithm": "exact"
        })

        client.run_enrichment_stage([{"entity": "e1"}])
        mock_request.assert_called_with("POST", "/memory/pipeline/enrichment", json_body={
            "linked_entities": [{"entity": "e1"}], "enrichment_types": ["sentiment", "topics"]
        })

        client.run_grounding_stage([{"entity": "e1"}])
        mock_request.assert_called_with("POST", "/memory/pipeline/grounding", json_body={
            "enriched_entities": [{"entity": "e1"}], "grounding_sources": ["wikipedia"]
        })

        client.get_pipeline_state("pipe-1")
        mock_request.assert_called_with("GET", "/memory/pipeline/pipe-1/state", params=None)
    ...
    def test_teams_methods(self, client, mock_request):
        ...
        mock_request.assert_called_with("POST", "/memory/teams", json_body={
        ...
        mock_request.assert_called_with("PUT", "/memory/teams/team-1", json_body={"name": "Team B"})
        ...
        mock_request.assert_called_with("POST", "/memory/teams/team-1/members", json_body={"user_id": "user-1", "role": "member"})

        client.update_team_member("team-1", "user-1", "admin")
        mock_request.assert_called_with("PUT", "/memory/teams/team-1/members/user-1", json_body={"role": "admin"})
    ...
    def test_temporal_methods(self, client, mock_request):
        ...
        mock_request.assert_called_with("GET", "/memory/temporal/item-1/history", params={"limit": 100})

        client.time_travel("2023-01-01T00:00:00Z")
        mock_request.assert_called_with("GET", "/memory/temporal/at/2023-01-01T00:00:00Z", params={"limit": 100})

        client.get_item_at_time("item-1", "2023-01-01T00:00:00Z")
        mock_request.assert_called_with("GET", "/memory/temporal/item-1/at/2023-01-01T00:00:00Z")

        client.get_changes("item-1")
        mock_request.assert_called_with("GET", "/memory/temporal/item-1/changes", params={})

        client.compare_versions("item-1", 1, 2)
        mock_request.assert_called_with("POST", "/memory/temporal/item-1/compare", params={"v1": 1, "v2": 2})

        client.rollback("item-1", to_version=1)
        mock_request.assert_called_with("POST", "/memory/temporal/item-1/rollback", params={"to_version": 1})

        client.get_audit_trail("item-1")
        mock_request.assert_called_with("GET", "/memory/temporal/item-1/audit", params={})

        client.search_during_range("query", "start", "end")
        mock_request.assert_called_with("GET", "/memory/temporal/search/during", params={
            "query": "query", "start_time": "start", "end_time": "end", "limit": 100
        })

        client.generate_compliance_report("start", "end")
        mock_request.assert_called_with("GET", "/memory/temporal/compliance/report", params={
            "start_date": "start", "end_date": "end", "report_type": "HIPAA"
        })

        client.get_relationship_history("rel-1")
        mock_request.assert_called_with("GET", "/memory/temporal/relationships/rel-1/history")

        client.get_relationships_at_time("time")
        mock_request.assert_called_with("GET", "/memory/temporal/relationships/at/time", params={"limit": 100})

        client.get_relationship_valid_periods("rel-1")
        mock_request.assert_called_with("GET", "/memory/temporal/relationships/rel-1/valid-periods")
    ...
    def test_zettelkasten_methods(self, client, mock_request):
        ...
        client.get_clusters()
        mock_request.assert_called_with("GET", "/memory/zettel/clusters", params={"min_size": 3, "algorithm": "louvain"})

        client.get_hubs()
        mock_request.assert_called_with("GET", "/memory/zettel/hubs", params={"min_connections": 5, "limit": 20})

        client.get_bridges()
        mock_request.assert_called_with("GET", "/memory/zettel/bridges", params={"limit": 20})

        client.get_discoveries("note-1")
        mock_request.assert_called_with("GET", "/memory/zettel/note-1/discoveries", params={"max_distance": 3, "min_surprise": 0.5})

        client.get_path("note-1", "note-2")
        mock_request.assert_called_with("GET", "/memory/zettel/note-1/path/note-2", params={"max_paths": 5})

        client.parse_wikilinks("content")
        mock_request.assert_called_with("POST", "/memory/zettel/wikilink/parse", params={"content": "content", "auto_create": True})

        client.resolve_wikilink("link")
        mock_request.assert_called_with("GET", "/memory/zettel/wikilink/resolve", params={"link": "link"})

        client.get_subgraph("note-1")
        mock_request.assert_called_with("GET", "/memory/zettel/note-1/graph", params={"depth": 2, "include_metadata": True})

        client.detect_concept_emergence()
        mock_request.assert_called_with("GET", "/memory/zettel/concept-emergence", params={"limit": 20})

        client.suggest_related_notes("note-1")
        mock_request.assert_called_with("GET", "/memory/zettel/note-1/suggestions", params={"count": 5})

        client.random_walk_discovery("note-1")
        mock_request.assert_called_with("GET", "/memory/zettel/note-1/random-walk", params={"length": 5})

        client.find_notes_by_tag("tag")
        mock_request.assert_called_with("GET", "/memory/zettel/by-tag/tag", params={"limit": 100})

        client.find_notes_by_property("key", "val")
        mock_request.assert_called_with("GET", "/memory/zettel/by-property", params={"key": "key", "value": "val", "limit": 100})

        client.find_notes_mentioning("entity")
        mock_request.assert_called_with("GET", "/memory/zettel/mentioning/entity", params={"limit": 100})

        client.query_by_dynamic_relation("src", "rel")
        mock_request.assert_called_with("GET", "/memory/zettel/by-relation/src/rel", params={"limit": 100})
